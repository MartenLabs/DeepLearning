...
class BackBone(tf.keras.layers.Layer):
    def __init__(self):
        ...
        self.L1dconv4CBAM = Conv(16, kernel_size=1, stride=1, padding='valid', kernel_regularizer=regularizers.l2(0.005))           
        self.L1dconv5CBAM = DepthwiseConv(out_channels=16, kernel_size=3, stride=1, padding='valid') # 16       
        ...
        self.L3dconv4CBAM = Conv(32, kernel_size=1, stride=1, padding='valid', kernel_regularizer=regularizers.l2(0.005))             
        self.L3dconv5CBAM = DepthwiseConv(out_channels=32, kernel_size=3, stride=1, padding='valid')
        ...
        self.L4dconv4CBAM = Conv(32, kernel_size=1, stride=1, padding='valid', kernel_regularizer=regularizers.l2(0.005))             
        self.L4dconv5CBAM = DepthwiseConv(out_channels=32, kernel_size=3, stride=1, padding='valid')
        ...
        self.L5dconv4CBAM = Conv(32, kernel_size=1, stride=1, padding='valid', kernel_regularizer=regularizers.l2(0.005))             
        self.L5dconv5CBAM = DepthwiseConv(out_channels=32, kernel_size=3, stride=1, padding='valid')

        


    def call(self, inputs):
        L0_conv1 = self.L0conv1(inputs)
        L0_padding = self.L0padding(L0_conv1)

        L1_conv2 = self.L1conv2(L0_padding)
        L1_conv3 = self.L1conv3(L1_conv2)
        L1_x1, L1_x2 = tf.split(L1_conv3, num_or_size_splits=2, axis=-1) # 8
        ...
        L3_conv1 = self.L3conv1((L1_dconv5CBAM + L1_reduce_noise) * L1_x2)
        ...
        out1 = (L3_dconv5CBAM + L3_reduce_noise) * L3_x2
        ...
        out2 = (L4_dconv5CBAM + L4_reduce_noise) * L4_x2
        ...
        out3 = (L5_dconv5CBAM + L5_reduce_noise) * L5_x2
