# nohup python 1Channel.py > 1Channel.log 2>&1 &
...
model_state_dict_path = [f"model_state_dict_1ch/{i}" for i in resolution_list]
...
class Trainer():
    ...
    def save_model(self):
        ...
        # 모델 상태를 저장할 기본 경로
        base_path = "model_state_dict_1ch"
    ...
    def test(self, epoch):
        ...
        # 이미지를 저장할 경로를 생성합니다.
        save_path = f"./1Channel_Log/{resolution_list[self.steps]}"
