# nohup python 1Channel_BRLoss.py > 1Channel_BRLoss.log 2>&1 &
...
model_state_dict_path = [f"model_state_dict_br/{i}" for i in resolution_list]
...
class Trainer():
    ...
    def test(self, epoch):
        ...
        # 이미지를 저장할 경로를 생성합니다.
        save_path = f"./1Channel_BRLoss_Log/{resolution_list[self.steps]}"
